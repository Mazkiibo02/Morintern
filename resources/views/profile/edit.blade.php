                ...
                <form id="formProfile" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="universitas_id" value="{{ $user->universitas_id ?? '' }}" required
                                class="w-full border rounded p-2 focus:ring focus:ring-blue-300 dark:bg-gray-700 dark:text-gray-100">
                        </div>

                        <div>
                            <label class="block text-gray-700 dark:text-gray-300">Jurusan</label>
                            <input type="text" name="jurusan_id" value="{{ $user->jurusan_id ?? '' }}"
                                class="w-full border rounded p-2 focus:ring focus:ring-blue-300 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="spesialisasi_id" required class="w-full border rounded p-2 focus:ring focus:ring-blue-300 dark:bg-gray-700 dark:text-gray-100">
                                <option value="">Pilih Spesialisasi</option>
                                @foreach ($spesialisasiOptions as $id => $label)
                                    <option value="{{ $id }}" @if($user->spesialisasi_id == $id) selected @endif>{{ $label }}</option>
                                @endforeach
</select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="cv" accept=".zip" class="w-full border rounded p-2 dark:bg-gray-700 dark:text-gray-100" required>
                            @if($user->cv)
                        ...
                        <div>
                            ...
                            <input type="file" name="surat" accept=".jpg,.jpeg,.png" class="w-full border rounded p-2 dark:bg-gray-700 dark:text-gray-100" required>
                            @if($user->surat)
