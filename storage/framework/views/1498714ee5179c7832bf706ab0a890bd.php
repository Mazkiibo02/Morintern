...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::guard('web')->check() || Auth::guard('peserta')->check()): ?>
...
<?php endif; ?>
                            ...
                            <!-- Authentication -->
                        <form method="POST" 
                            action="<?php echo e(Auth::guard('peserta')->check() ? route('peserta.logout') : route('logout')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Document\KULIAH\projectmagang\Morintern\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>