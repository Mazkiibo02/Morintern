...
<header class="w-full">
    <div class="max-w-[1440px] mx-auto px-8 lg:px-12 py-6 flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-8 text-sm">
            ...
            <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 border border-gray-200 rounded-md text-sm">Masuk</a>
            <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-[#648DDB] text-white rounded-md text-sm">Daftar</a>
        </nav>
    </div>
    ...
    <div x-show="mobileMenuOpen" class="lg:hidden" style="display: none;">
        <nav class="px-8 py-4 space-y-4">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-4 py-2 border border-gray-200 rounded-md text-sm">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="block w-full text-center px-4 py-2 bg-[#648DDB] text-white rounded-md text-sm">Daftar</a>
            </div>
        </nav>
    </div>
