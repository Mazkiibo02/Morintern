    ...
    <div class="max-w-[1440px] mx-auto px-8 lg:px-12">
        ...
        <div>
            <p class="text-sm text-gray-100">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Morbis.id.
            </p>
        </div>

    </div>
</footer>
<?php /**PATH D:\Document\KULIAH\projectmagang\Morintern\resources\views/landing/components/footer.blade.php ENDPATH**/ ?>