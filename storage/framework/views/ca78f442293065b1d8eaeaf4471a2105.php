...
<section id="lowongan" class="bg-white mt-8">
    ...
    <div class="max-w-[1440px] mx-auto px-8 lg:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            <?php $__currentLoopData = ['Quality assurance','Backend Dev','System Analys','Front And']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="text-center mt-10">
            <a href="<?php echo e(route('register')); ?>" class="px-6 py-2 bg-white border rounded-md text-[#648DDB] font-semibold">DAFTAR</a>
            <div class="mt-4">
...
<section id="lowongan" class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('register')); ?>" class="inline-block bg-[#678DE5] text-white px-6 py-3 rounded-md font-semibold hover:bg-blue-600 transition-colors">
                DAFTAR
            </a>
...
</section><?php /**PATH D:\Document\KULIAH\projectmagang\Morintern\resources\views/landing/components/jobs.blade.php ENDPATH**/ ?>