<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Setelah akun Anda dihapus, semua data yang terkait dengan akun tersebut akan dihapus secara permanen. Sebelum menghapus akun Anda, pastikan anda yakin menghapus akun ini.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(Auth::guard('peserta')->check() ? route('peserta.profil.destroy') : route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('Apakah kamu yakin menghapus akunmu?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Setelah akun kamu dihapus, semua data yang terkait dengan akun tersebut akan dihapus secara permanen. Sebelum menghapus akun kamu, pastikan kamu yakin menghapus akun ini.')); ?>
...
<?php /**PATH D:\Document\KULIAH\projectmagang\Morintern\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>